...
const Header = () => {
  return (
    <>
      <header name="home" className="w-full h-screen bg-black/50 ">
        {/* VIDEO */}
        <video className="object-cover w-full h-screen mix-blend-overlay" src={video} autoPlay muted loop />
        {/* TEXT */}
        <div className="absolute w-96 h-auto sm:w-[37rem] lg:w-[45rem] text-white top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] space-y-2">
          <p className="text-sm sm:text-lg sm:font-medium">Hii My Name is</p>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl uppercase font-medium"> <p className="text-sky-500"> Rajender Kumar</p></h1>
          <p className="text-3xl sm:text-5xl lg:text-6xl font-semibold text-gray-200">I'm a Front-End Developer</p>
