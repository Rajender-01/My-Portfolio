...
const Form = () => {
  return (
    ...
    <form  action="https://getform.io/f/cb9739f5-e237-40fa-95b6-c0f0a9c3d99a" method="POST" className='max-w-4xl p-10 grid place-items-center h-full mx-auto'>
            ...
            <button className='w-36 h-12 bg-sky-500 mx-auto my-4 lg:my-6 rounded-md lg:animate-bounce duration-300 lg:hover:animate-none hover:bg-sky-400 shadow-md shadow-gray-400'>Lets Collaborate</button>
        </form>
    </section>
    </>
  )
